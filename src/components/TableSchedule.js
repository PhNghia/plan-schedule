...
export default function TableSchedule({ columns }) {
    ...
    return (
        <div>
            <div ref={tableScheduleRef} style={{ padding: "10px" }}>
                <div className={styles['table']}>
                    ...
                    <ul className={styles['first-col']}>
                        {constants.LESSONS.map(lesson =>
                            <li key={lesson.value} value={lesson.value}>
                                <p>{lesson.lesson}</p>
                                <p>
                                    <span>{lesson.time[0]}</span>
                                    <span> &#8594; </span>
                                    <span>{lesson.time[1]}</span>
                                </p>
                            </li>)}
                    </ul>
